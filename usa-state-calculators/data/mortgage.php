...
function usc_get_mortgage_variations() {
    return [
        'intro' => [
            "Buying a home is one of the most significant financial steps you will take, and understanding your potential mortgage payments is crucial. In {state_name}, your final monthly payment consists of more than just the loan principal and interest rate. Real estate taxes, homeowners insurance, and potential association fees can greatly impact your monthly budget.",
            "For prospective home buyers in {state_name}, navigating monthly payments requires a clear view of all housing costs. A complete mortgage estimate helps you understand what you will actually pay each month, ensuring you choose a loan term and home price that fit comfortably within your income limits.",
            "Before shopping for properties in {state_name}, it is wise to calculate your estimated home financing costs. Between local property tax rates, homeowner hazard insurance, and principal repayments, your final monthly PITI payment can vary. A detailed calculator gives you the foresight needed to make an affordable offer."
        ],
        'whatis' => [
        ...
        'conclusion' => [
            "Understanding the full breakdown of your monthly mortgage payment is essential for successful homeownership. Use this {state_name} mortgage calculator to plan your budget, test prepayment scenarios, and purchase your home with confidence.",
            "In conclusion, knowing your monthly PITI and closing costs ensures a smooth home-buying experience. By utilizing our advanced mortgage tool, you can model your financing and plan your path to debt-free homeownership.",
            "Managing your home financing effectively starts with accurate calculations. Our {state_name} mortgage calculator is here to help you analyze PITI payments, optimize extra payments, and achieve your financial goals."
        ]
    ];
}
